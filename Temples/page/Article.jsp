    ...
    <div class="row">
        <div class="col-9">
            <div class="card jt-card jt-top-card mt-1 mb-1"
                 ...
                 style="background: url('<%=_route.equals("/product/") ? IntroSettings.getJsonObject("top_img").getString("product_article") : IntroSettings.getJsonObject("top_img").getString(_route.replace("/",""))%>') no-repeat center center;
